...
export const PORTALDOT_MAINNET_CHAIN_ID = Number(
  import.meta.env.VITE_PORTALDOT_CHAIN_ID || 42220,
);
export const CELO_MAINNET_CHAIN_ID = PORTALDOT_MAINNET_CHAIN_ID;
